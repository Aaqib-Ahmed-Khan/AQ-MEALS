    ...
    <header className="text-gray-600 body-font">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
          ...
          <Link to={'about'} className="mr-5 hover:text-gray-900">About Us</Link>
          <Link to={'recipes'} className="mr-5 hover:text-gray-900">Recipe</Link>
          <Link to={'AddRecipe'} className="mr-5 hover:text-gray-900">Add Recipe</Link>
          {user ? ( // Show these links only if user is logged in
            <>
              <Link to={'/myrecipes'} className="mr-5 hover:text-gray-900">My Recipes</Link>
              <button 
                onClick={handleLogout} 
                className="mr-5 hover:text-gray-900 bg-transparent border-none cursor-pointer"
              >
                Log Out
              </button>
            </>
